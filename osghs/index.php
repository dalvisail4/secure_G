...
<form method="post" value="">
    <div>
        ...
        <input type="text"  placeholder="First Name" id="name" name="fname" class="form-control" required pattern="[A-Za-z]+" title="Only alphabets are allowed">
        <span class="error"></span>
    </div>							
							<div class="col-md-12">
							<!DOCTYPE html>
...
<form method="post" value="">
    <div>
		...
		<span class="error">  *  </span>
        <input type="text" placeholder="Last Name" id="name" name="lname" class="form-control" required pattern="[A-Za-z]+" title="Only alphabets are allowed">
        <span class="error"></span>
    </div>
							<div class="col-md-12">
							<!DOCTYPE html>
...
<form method="post" >
    <div>
		...
		<span class="error">  *  </span>
        <input type="phone"  placeholder="Phone Number" class="form-control" id="phone" name="mobnum" value=""  required='true' required pattern="[0-9]{10}" title="Please enter exactly 10 digits">
    </div>
